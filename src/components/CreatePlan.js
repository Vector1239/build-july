...
export default function CreatePlan(props) {
    ...
    return (
        <>
            <div className="flex justify-end bg-offPurPur min-h-auto mx-2 w-1/4">
                        ...
                        {!planName && plans.length === 0 && (
                            <div className="my-8 text-center flex-grow">
                                <h1 className="font-medium text-xs w-13">
                                    Efficiently manage and track your influencers based on your campaign objectives.
                                    Create a customized plan to curate and organize your influencer marketing efforts.
                                </h1>
                                <Button
                                    style={{
                                        textTransform: 'none',
                ...
                >
                    ...
                    <DialogContent style={{ fontFamily: 'Montserrat' }}>
                        <DialogContentText className="text-bluey">Name of Plan</DialogContentText>
                        <TextField
                            autoFocus
                            margin="dense"
                            id="name"
